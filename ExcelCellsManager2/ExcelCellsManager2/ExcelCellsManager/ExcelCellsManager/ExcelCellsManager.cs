...
namespace ExcelCellsManager.ExcelCellsManager
{
    public class ExcelCellsManager
    {
        ...
        public ExcelIO.ExcelApps.ActiveCellsInfo ActiveCellsInfo;
        ...
        private string GetValue2(in Worksheet worksheet, in Range range)
        {
            try
            {
                ...
                {
                    ExcelIO.ExcelFinderAddress util = new ExcelIO.ExcelFinderAddress(_error);
                    string address = util.GetCornerAddressFromRangeAddress(worksheet, range.Address,
                        ExcelIO.ExcelFinderAddress.ExcelFinderAddressConstants.DIRECTION_UP |
                        ExcelIO.ExcelFinderAddress.ExcelFinderAddressConstants.DIRECTION_LEFT);
