...
{
    public class ExcelValueFinder
    {
        protected ErrorManager.ErrorManager _Error;
        //protected Range _Range = null;
        public ExcelValueFinderConstants EnumConst = new ExcelValueFinderConstants();
        public ExcelValueFinder(ErrorManager.ErrorManager error)
        {
            _Error = error;
        }
        ...
        public long GetIncludeCellsCountInRangeAddress(in Worksheet worksheet,string checkAddress,string rangeAddress)
        {
            try
            {
                ExcelAddressChecker checkAddressClass = new ExcelAddressChecker(_Error, checkAddress);
                ExcelAddressChecker rangeAddressClass = new ExcelAddressChecker(_Error, rangeAddress);
