...
namespace ExcelIO
{
    public class ExcelAddressForLoop
    {
        ...
        protected ExcelFinderAddress _addressUtil;
        ...
        public ExcelAddressForLoop(ErrorManager.ErrorManager error, string address)
        {
            _error = error;
            _address = address;
            _addressUtil = new ExcelFinderAddress(error);
        }
