...
namespace ControlUtility
{
    public class ChangeSizeByMouseWheel
    {
        ...
        public ChangeSizeByMouseWheel(ErrorManager.ErrorManager err, Control control, Control parentControl)
        {
            _err = err;
        ...
        public ChangeSizeByMouseWheel(ErrorManager.ErrorManager err, 
            Control control, Control parentControl
            , EventHandler wheelBegin, EventHandler wheelEnd)
        {
            _err = err;
            _innerControl = control;
            _parentControl = parentControl;
        ...
        private void Control_MouseWheel(object sender, MouseEventArgs e)
        {
            ...
            {
                _err.AddException(ex, this, "MouseWheelEvent");
            }
            finally
            {
        ...
        public void ControlPausePaint(bool flag)
        {
            ...
            {
                _err.AddException(ex, this, "ControlSuspendLayout Failed");
            }
        }
        ...
        public void ExpansionSizeViewControl(double raito)
        {
            try
            {
                _err.AddLog(this, "ExpansionSizeViewControl");
                ...
                if((newSize.Width == 0)&&(raito > 1.0)) {
                    _err.AddLog("  ((newSize.Width == 0)||(raito > 1.0))==true => Resize");
                ...
                _err.AddLog(" Size:"+_innerControl.Size.Width + "," + _innerControl.Size.Height + "=>" 
                    + newSize.Width + "," + newSize.Height);
                // ポジション変更
                _innerControl.Location = newLocation;
                _err.AddLog(" Location:" + _innerControl.Location.X + "," + _innerControl.Location.Y + "=>"
            ...
            {
                _err.AddException(ex, this, "ChangeSizeViewControl Failed");
            }
        }
        ...
        public void SaveRaitoSizeAndPositionFromFrameControl()
        {
            ...
            {
                _err.AddException(ex, this, "saveDifferenceSizeAndPositionFromFramecControl Failed");
                return;
            }
        }
        /// <summary>
        ...
        public Point GetLocationByCalcExpansionWhenChangeSize(Size beforeSize, Size afterSize)
        {
            ...
            {
                _err.AddException(ex, this, "ChangeLocationWhenChangeSize Failed");
                return new Point();
            }
        }
    }
