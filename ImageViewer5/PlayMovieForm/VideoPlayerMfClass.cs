...
using static PlayMovieForm.VideoPlayerMf;
...
namespace PlayMovieForm
{
    ...
    public class VideoPlayerMf : IDisposable, IMFAsyncCallback
    {
        ...
        [ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown), Guid("5B87EF6A-7ED8-434F-BA0E-184FAC1628D1")]
        public interface IMFPropertyStore
        {
            // 必要なメソッドを定義（省略可能）
        }
        ...
        // COMインターフェースの定義
        [ComImport, InterfaceType(ComInterfaceType.InterfaceIsIUnknown), Guid("2E0AE66C-27AD-414b-BE23-29C6F3609B1F")]
        ...
        {
            [PreserveSig]
            HRESULT SetUnknown([In] Guid guidKey, [MarshalAs(UnmanagedType.IUnknown)] object pUnknown);
        ...
        // private static readonly Guid MF_TOPONODE_SOURCE = new Guid("SOURCE GUID"); // 実際のGUIDを使用
        // private static readonly Guid MF_TOPONODE_PRESENTATION_DESCRIPTOR = new Guid("PRESENTATION_DESCRIPTOR GUID"); // 実際のGUIDを使用
        // private static readonly Guid MF_TOPONODE_STREAM_DESCRIPTOR = new Guid("STREAM_DESCRIPTOR GUID"); // 実際のGUIDを使用

        private static readonly Guid MF_TOPONODE_SOURCE = new Guid("83CF873A-F6DA-4BC8-823F-BACFD55DC430");
        private static readonly Guid MF_TOPONODE_PRESENTATION_DESCRIPTOR = new Guid("D2D7435F-A63D-456F-9831-78D6FEF10B42");
        private static readonly Guid MF_TOPONODE_STREAM_DESCRIPTOR = new Guid("776E7E0D-1E2D-432C-AAF9-FAF0C631C91F");
